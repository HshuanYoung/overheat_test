...
const trigger_10403061_entry_exhaust: CardEffect = {
  id: '10403061_entry_exhaust',
  type: 'TRIGGER',
...
const activate_10403061_swap: CardEffect = {
  id: '10403061_swap_activate',
  type: 'ACTIVATE',
  triggerLocation: ['UNIT'],
  limitCount: 1,
  limitNameType: true,
...
const card: Card = {
  ...
  canResetCount: 0,
  effects: [
    trigger_10403061_entry_exhaust,
    activate_10403061_swap
  ],
  rarity: 'U',
  availableRarities: ['U'],
  uniqueId: null,
