...
const effect_104010220_front: CardEffect = {
  ...
  condition: (gameState: GameState, playerState: PlayerState, instance: Card) => {
    ...
    // 2. Godmark Limit Check (e.g. from 1040101739 fuka_restriction)
...
const effect_104010220_hand: CardEffect = {
  id: 'seii_to_erosion',
  type: 'ACTIVATE',
...
const card: Card = {
  ...
  canResetCount: 0,
  effects: [
    effect_104010220_front,
    effect_104010220_hand
  ],
  rarity: 'SR',
