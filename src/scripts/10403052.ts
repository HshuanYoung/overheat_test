...
const trigger_10403052_enter: CardEffect = {
  id: '10403052_enter_combat_guard',
  type: 'TRIGGER',
...
const activate_10403052_from_erosion: CardEffect = {
  id: '10403052_play_from_erosion',
  type: 'ACTIVATE',
...
const card: Card = {
  ...
  canResetCount: 0,
  effects: [
    trigger_10403052_enter,
    activate_10403052_from_erosion
  ],
  rarity: 'U',
  availableRarities: ['U'],
  uniqueId: null,
